...
urlpatterns = [
    ...
    path("get-submodules/", views.get_submodules, name="get_submodules"),
     path("get-subsubmodules/<int:submodule_id>/", views.get_subsubmodules, name="get_subsubmodules"),
     path("calculate-estimate/", views.calculate_estimate, name="calculate_estimate"),
